...
namespace PurchaseOrderApp.Infrastructure.Migrations
{
    ...
    [Migration("20260905113358_SimplifyOutboxPublishing")]
    partial class SimplifyOutboxPublishing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PurchaseOrderApp.Infrastructure.Background.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("CreatedUtc")
                        .HasDatabaseName("ix_outbox_message_created_utc")
                        .HasFilter("published_utc IS NULL");
